...
// Initialize here and set items when DOMContentLoaded
var items = [];
var itemsLength;
...
function updatePositions() {
  ...
  // Store left offset to phaseArray array for reuse.
  var scrollValue = document.body.scrollTop / 1250;
  var phaseArray = [];
  var i = 0;
  for (i = 0; i < 5; ++i) {
    phaseArray.push(Math.sin(scrollValue + (i%5)));
  }

  // Use transform to change items position
